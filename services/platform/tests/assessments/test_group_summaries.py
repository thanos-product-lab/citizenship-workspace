...
from app.assessments.groups import GroupMember, summarise_group, summarise_groups
...
def test_one_stale_member_makes_the_group_stale() -> None:
    ...
    assert summary.conclusion_counts == {Conclusion.SUPPORTED.value: 3}
...
def test_not_yet_assessed_is_counted_apart_from_conclusions() -> None:
    ...
    assert summary.conclusion_counts == {Conclusion.SUPPORTED.value: 1}
    assert Conclusion.NOT_YET_ASSESSED.value not in summary.conclusion_counts
